//! Analysis G (subject-stratified) — hammerAP per face-block image-resized:
...
pub fn run(cfg: &AppConfig) -> Result<()> {
    ...
    info!("starting task_per_block_resized subject-stratified classification");
    ...
    info!(
        ...
        "task_per_block_resized subject-stratified done"
    );
    Ok(())
}
