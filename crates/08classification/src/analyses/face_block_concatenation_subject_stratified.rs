//! Analysis C (subject-stratified) — hammerAP task concat: subject-disjoint
...
pub fn run(cfg: &AppConfig) -> Result<()> {
    ...
    info!("starting task_concat (face) subject-stratified classification");
    ...
    info!(
        ...
        "task_concat subject-stratified done"
    );
    Ok(())
}
