//! Analysis H (subject-stratified) — hammerAP task averaged image-resized:
...
pub fn run(cfg: &AppConfig) -> Result<()> {
    ...
    info!("starting task_averaged_resized subject-stratified classification");
    ...
    info!(
        ...
        "task_averaged_resized subject-stratified done"
    );
    Ok(())
}
