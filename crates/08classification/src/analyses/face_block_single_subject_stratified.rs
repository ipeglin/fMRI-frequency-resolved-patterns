//! Analysis D (subject-stratified) — hammerAP per face-block: subject-disjoint
...
pub fn run(cfg: &AppConfig) -> Result<()> {
    ...
    info!("starting task_per_block subject-stratified classification");
    ...
    info!(
        ...
        "task_per_block subject-stratified done"
    );
    Ok(())
}
